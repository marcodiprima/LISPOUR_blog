...
<html>
    <head>
        ...
        <script src="<?php echo e(asset('js/homepage.js')); ?>" defer="true"></script>
    ...
    <nav class="navig">
        <a href="<?php echo e(url('spotify')); ?>">SONGS</a>
    ...
    <div class="userpic">
        <h1><strong><?php echo e($nome); ?> <?php echo e($cognome); ?></strong></h1>
    </div>
    ...
    <footer id='piedi'> 
        <div>
        <hr>
        <p class='foot'><?php echo e($nome); ?> <?php echo e($cognome); ?> - travel vlogger - p.iva: 0394854829204<p>
        </div>
    </footer>
  </body>
</html>
